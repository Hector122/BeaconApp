...
public class CustomCategoryAdapter extends RecyclerView.Adapter<CustomCategoryAdapter.ViewHolder> {
    ...
    public CustomCategoryAdapter(SponsorCategory[] sponsors, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.viewHolder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(CategoryActivity.EXTRA_DRAWABLE_ID, items.get(position).getIdDrawable());
